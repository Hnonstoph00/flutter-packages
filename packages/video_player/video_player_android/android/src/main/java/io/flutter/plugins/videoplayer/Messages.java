...
public class Messages {
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static final class DubMessage {
    private @NonNull Long textureId;
    ...
    public boolean equals(Object o) {
      if (this == o) { return true; }
      if (o == null || getClass() != o.getClass()) { return false; }
      DubMessage that = (DubMessage) o;
      return textureId.equals(that.textureId) && name.equals(that.name);
    }

    @Override
    public int hashCode() {
      return Objects.hash(textureId, name);
    }
    ...
    public static final class Builder {
      ...
      public @NonNull DubMessage build() {
        DubMessage pigeonReturn = new DubMessage();
        pigeonReturn.setTextureId(textureId);
    ...
    static @NonNull DubMessage fromList(@NonNull ArrayList<Object> pigeonVar_list) {
      DubMessage pigeonResult = new DubMessage();
      Object textureId = pigeonVar_list.get(0);
      pigeonResult.setTextureId((Long) textureId);
  ...
  private static class PigeonCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, @NonNull ByteBuffer buffer) {
      switch (type) {
        ...
        case (byte) 133:
          return DubMessage.fromList((ArrayList<Object>) readValue(buffer));
        case (byte) 134:
    ...
    protected void writeValue(@NonNull ByteArrayOutputStream stream, Object value) {
      ...
      } else if (value instanceof DubMessage) {
        stream.write(133);
        writeValue(stream, ((DubMessage) value).toList());
  ...
  public interface AndroidVideoPlayerApi {
    ...
    static void setUp(@NonNull BinaryMessenger binaryMessenger, @NonNull String messageChannelSuffix, @Nullable AndroidVideoPlayerApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.video_player_android.AndroidVideoPlayerApi.setDub" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
